...
public class ActivitiProperties {
    ...
    private boolean checkProcessDefinitions = false;
    ...
    private String databaseSchemaUpdate = "false";//是否更新表结构
    private String databaseSchema;
    private boolean isDbIdentityUsed = false;//使用视图覆盖原有的部分表结构
    private boolean isDbHistoryUsed = true;
    private HistoryLevel historyLevel = HistoryLevel.FULL;
